...
final class Keychain {
    ...
    @discardableResult static func setPassword(_ password: String,
    ...
    @discardableResult static func deletePassword(forAccount account: String,
                                                  service: String = bundleIdentifier,
                                                  accessGroup: String = "") -> Bool {
        guard !service.isEmpty && !account.isEmpty else {
            return false
    ...
    fileprivate static func query(_ action: Action, _ query: [String : AnyObject],
                                  _ password: String = "") -> (OSStatus, String) {
